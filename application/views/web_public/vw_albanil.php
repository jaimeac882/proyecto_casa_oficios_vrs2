                       ...
                       <li><a href="<?php echo base_url('web_public/trabaja_con_nosotros'); ?>">Trabaja con Nosotros</a></li>
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="active"><a href="<?php echo base_url('web_public/oficio_albanil'); ?>">Albañilería</a></li>
        ...
        <div class="container">
           <div class=" wow fadeInDown" >
                ...
                <div class="col-sm-7">
                    ...
                    <h1 style="color:black;">Albañilería</h1>
                    <p  class="lead" style="color:black;">
                    
                    Para las diversas tareas que tiene en mente para su casa.
                    <ul class="list-group">
                        <li>Refaccionar un muro.</li>
                        <li>Tarrajear una pared.</li>
                        <li>Construir un nuevo lavatorio.</li>
                        <li>Aplicar un escarchardo para el techo.</li>
                 ...
                 <div class="col-sm-5 hidden-xs animation animated-item-4">
                        <div class="slider-img">
                            <img style="height: 60%;width: 60%" src="<?php echo base_url("assets/images/slider/img4.png"); ?>" class="img-responsive">
                        </div>
                </div>                       
