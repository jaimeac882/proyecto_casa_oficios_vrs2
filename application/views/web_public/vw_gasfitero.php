                       ...
                       <li><a href="<?php echo base_url('web_public/trabaja_con_nosotros'); ?>">Trabaja con Nosotros</a></li>
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="active"><a href="<?php echo base_url('web_public/oficio_gasfitero'); ?>">Gasfitería</a></li>
        ...
        <div class="container">
           <div class=" wow fadeInDown" >
                ...
                <div class="col-sm-7">
                    ...
                    <h1 style="color:black;">Gasfitería</h1>
                    <p  class="lead" style="color:black;">
                    
                    Para las diversas tareas que tiene en mente para su casa.
                    <ul class="list-group">
                        <li>Reparar los grifos del baño, cocina, etc. </li>
                        <li>Detección de filtración de agua e instalación de cañerías.</li>
                        <li>Refacciones de la tubería del desagüe.</li>
                        <li>Mantenimiento de las válvulas del agua caliente.</li>
                 ...
                 <div class="col-sm-5 hidden-xs animation animated-item-4">
                        <div class="slider-img">
                            <img style="height: 60%;width: 60%" src="<?php echo base_url("assets/images/slider/img1.png"); ?>" class="img-responsive">
                        </div>
                </div>                       
