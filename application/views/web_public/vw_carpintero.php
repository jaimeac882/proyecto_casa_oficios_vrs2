...
<body>
                       ...
                       <li><a href="<?php echo base_url('web_public/trabaja_con_nosotros'); ?>">Trabaja con Nosotros</a></li>
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="active"><a href="<?php echo base_url('web_public/oficio_carpintero'); ?>">Carpintería</a></li>
        ...
        <div class="container">
           <div class=" wow fadeInDown" >
                ...
                <div class="col-sm-7">
                    ...
                    <h1 style="color:black;">Carpintería</h1>
                    <p  class="lead" style="color:black;">
                    
                    Para las diversas tareas que tiene en mente para su casa.
                    <ul class="list-group">
                        <li>Construir alguna equipación de muebles: silla, meza, estantes </li>
                        <li>Habilitar marcos de madera para sus ventanas.</li>
                        <li>Remodelar su puerta</li>
                        <li>Mandar a contruir alguna manualidad personalizada en madera.</li>
                 ...
                 <div class="col-sm-5 hidden-xs animation animated-item-4">
                        <div class="slider-img">
                            <img style="height: 60%;width: 60%" src="<?php echo base_url("assets/images/slider/img3.png"); ?>" class="img-responsive">
                        </div>
                </div>                       
    ...
    <div class="clients-area center wow fadeInDown">
        <h2>
            ¿Qué dicen nuestros usuarios?</h2>
        <p class="lead">
            Aquí está el testimonio de los usuarios que dejan constancia el trabajo realizado. A continuación, algunos de ellos:
            .</p>
    </div>
    <div class="container">
