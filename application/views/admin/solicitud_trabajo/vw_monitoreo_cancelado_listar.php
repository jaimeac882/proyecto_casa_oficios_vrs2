...
<table style="display: block; overflow-x: scroll;" id="grid-data" class="table table-condensed table-hover table-striped" width="60%" cellspacing="0" data-toggle="bootgrid">
    <thead>
        <tr>
            ...
            <th data-column-id="COD_TMRH_ASIG" >Código TMRH</th>
            <th data-column-id="NOM_TMRH_ASIG" >Nombre TMRH</th>
            <th data-column-id="ESTADO_ASIGNACION" >Estado Asignado</th>     
...
$("#grid-data").bootgrid({
    ...
    url: url_web+"json_listar_solicitudes/4",    
    selection: false,
    multiSelect: false,
    labels: {
