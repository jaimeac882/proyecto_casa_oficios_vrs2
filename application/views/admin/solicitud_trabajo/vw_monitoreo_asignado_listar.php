...
<table style="display: block; overflow-x: scroll;" id="grid-data" class="table table-condensed table-hover table-striped" width="60%" cellspacing="0" data-toggle="bootgrid">
    <thead>
        <tr>
            ...
            <th data-column-id="COD_TMRH_ASIG" >Código de TMRH</th>
            <th data-column-id="NOM_TMRH_ASIG" >Nombre Apellido del TMRH</th>
            <th data-column-id="ESTADO_ASIGNACION" >Estado Asignación</th>     
            <th data-column-id="NOMBRE_CLIENTE" >Nombre del Cliete</th>            
            ...
            <!--th data-column-id="DESCRIP_CASO" >Descr</th-->
            <th data-column-id="FEC_REGISTRO" >Fecha Regitrado</th>                           
...
$("#grid-data").bootgrid({
    ...
    url: url_web+"json_listar_solicitudes/2",    
    selection: false,
    multiSelect: false,
    labels: {
